function varargout = L3ZDT3(varargin)
%L3ZDT3  L3ZDT3 (n=30, m=2) test problem (heterogeneous WORK-space wrapper).
%
...
%
% USAGE:
%   F = L3ZDT3(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = L3ZDT3('bounds')  % Get bounds
%   info = L3ZDT3()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
if nargin == 0
    ...
    info.pareto_note = 'L3ZDT3: Expected PF same as ZDT3 (disconnected); landscape-modified. Ref: Deb et al. (2006).';
...
F = L3ZDT3_orig(x_orig);
varargout{1} = F(:);
return
end  % main wrapper function

% -------------------------------------------------------------------------
% Embedded original problem function (verbatim; only renamed to L3ZDT3_orig)
% -------------------------------------------------------------------------
function f = L3ZDT3_orig(x)
% L3ZDT3 function
%
...
M = [
    ...
    -0.699445, 0.237731, -0.324597, -0.800406, -0.42585, -0.710739, -0.144068, -0.828545, -0.800912, 0.184654, -0.63675, -0.16696, 0.240427, -0.513443, 0.812664, 0.744943, 0.970612, 0.00172899, -0.726378, -0.0985012, -0.0955366, 0.0187107, 0.913887, 0.123076, 0.550338, -0.0955366, 0.0187107, 0.913887, 0.123076, 0.550338;
    0.400334, -0.367816, 0.198455, -0.983183, 0.278976, 0.714817, 0.307911, 0.812861, -0.403497, -0.784382, -0.161823, -0.120835, 0.323172, 0.583739, 0.732924, -0.220603, -0.594121, 0.935093, -0.216736, 0.659318, -0.763681, 0.0781023, 0.951666, 0.734031, 0.826912, -0.763681, 0.0781023, 0.951666, 0.734031, 0.826912;
    0.57488, -0.361951, -0.0739728, 0.91438, -0.391653, 0.0193887, 0.412634, -0.169813, 0.471794, 0.660792, -0.350906, -0.612644, 0.347876, 0.112573, -0.501126, 0.456761, -0.109004, 0.289352, -0.566504, 0.585042, 0.0853141, -0.583368, -0.157612, 0.234119, 0.875043, 0.0853141, -0.583368, -0.157612, 0.234119, 0.875043;
    0.430805, 0.706102, 0.423887, 0.296828, -0.265607, 0.338806, -0.15829, 0.642516, 0.355126, 0.174447, -0.975015, 0.869905, -0.145285, -0.484002, -0.475966, -0.67704, 0.996452, -0.0685748, -0.851985, 0.416498, -0.116586, -0.896382, -0.817317, -0.948837, -0.597427, -0.116586, -0.896382, -0.817317, -0.948837, -0.597427;
    0.975863, -0.971371, -0.124115, 0.4339, -0.254671, 0.298068, -0.349803, -0.73185, 0.488106, -0.0495073, 0.253969, 0.168116, 0.148772, 0.889593, -0.512213, -0.165437, 0.666773, -0.976304, -0.170024, 0.905794, 0.842925, -0.144503, 0.936699, -0.443935, -0.182996, 0.842925, -0.144503, 0.936699, -0.443935, -0.182996;
    0.803564, 0.960386, -0.0323329, 0.638181, -0.895684, -0.360502, 0.0646258, -0.202449, -0.717228, 0.970489, 0.404608, -0.0861868, -0.879417, -0.866462, -0.938336, -0.799685, 0.213464, -0.932344, -0.668236, 0.751366, -0.868866, -0.504041, 0.926483, 0.169978, -0.00842563, -0.868866, -0.504041, 0.926483, 0.169978, -0.00842563;
    -0.530324, 0.282745, 0.0255867, 0.287686, 0.410417, -0.766576, -0.536566, -0.628288, 0.69665, 0.820713, -0.506162, -0.404114, 0.640099, -0.956123, -0.576586, 0.435502, -0.470676, -0.367062, -0.831765, -0.294942, 0.916684, 0.39175, 0.759081, 0.496979, -0.200691, 0.916684, 0.39175, 0.759081, 0.496979, -0.200691;
    0.0417966, -0.687391, 0.438773, 0.287357, 0.316636, -0.262311, -0.0755541, -0.442313, 0.621378, 0.670105, 0.060982, 0.944162, 0.643442, -0.750684, -0.639973, 0.217424, 0.592823, 0.929094, -0.239135, -0.41628, 0.0626998, -0.977963, 0.660401, 0.470569, -0.0528868, 0.0626998, -0.977963, 0.660401, 0.470569, -0.0528868;
...
% Cálculo das variáveis y usando a transformação quadrática (diferente de L2ZDT1)
y = zeros(m,1);
for i = 1:m
    y(i) = 0;
    for j = 1:m
...
% Função h - Note a inclusão de termo de seno (diferente de L3ZDT1 e L3ZDT2)
