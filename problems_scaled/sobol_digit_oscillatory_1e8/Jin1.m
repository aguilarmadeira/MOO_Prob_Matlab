...
%JIN1  Jin1 (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 5.65638e+07 ]   (range: 5.65638e+07 )
%   x2   ∈ [0           , 3728.21     ]   (range: 3728.21     )
%
% Effective contrast ratio (max range / min range): 15171.83950602808
...
%
% USAGE:
%   F = Jin1(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = Jin1('bounds')  % Get bounds
%   info = Jin1()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [56563771.51813466;3728.2078745732];
scale_factors = [56563771.51813466;3728.2078745732];
contrast_ratio = 15171.83950602808;
...
if nargin == 0
    ...
    info.pareto_note = 'Jin1: No analytical PF documented. Ref: Jin et al. (2001).';
