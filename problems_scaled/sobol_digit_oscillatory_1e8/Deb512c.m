...
%DEB512C  Deb512c (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 5105.51     ]   (range: 5105.51     )
%   x2   ∈ [0           , 3.5003e+07  ]   (range: 3.5003e+07  )
%
% Effective contrast ratio (max range / min range): 6855.927412244152
...
%
% USAGE:
%   F = Deb512c(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = Deb512c('bounds')  % Get bounds
%   info = Deb512c()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [5105.511001044286;35003012.8255736];
scale_factors = [5105.511001044286;35003012.8255736];
contrast_ratio = 6855.927412244152;
...
if nargin == 0
    ...
    info.pareto_note = 'Deb512c: Concave PF. Ref: Deb (1999).';
