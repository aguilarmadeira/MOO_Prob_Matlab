...
%DEB521B  Self-contained scaled MOO test problem.
%
...
% Effective contrast: 3208.179104348142
%
% API:
%   info = Deb521b();
%   [lb,ub] = Deb521b('bounds');
%   F = Deb521b(x);
%
% Mapping:
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [25439683.07429319;7929.633055652665];
scale_factors = [25439683.07429319;7929.633055652665];
contrast_ratio = 3208.179104348142;
