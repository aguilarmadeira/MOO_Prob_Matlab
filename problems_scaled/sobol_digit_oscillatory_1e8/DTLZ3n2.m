...
%DTLZ3N2  DTLZ3n2 (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 4.70077e+07 ]   (range: 4.70077e+07 )
%   x2   ∈ [0           , 7.44567e+07 ]   (range: 7.44567e+07 )
%
% Effective contrast ratio (max range / min range): 1.583924460781781
...
%
% USAGE:
%   F = DTLZ3n2(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = DTLZ3n2('bounds')  % Get bounds
%   info = DTLZ3n2()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [47007748.92276394;74456723.36505422];
scale_factors = [47007748.92276394;74456723.36505422];
contrast_ratio = 1.583924460781781;
...
if nargin == 0
    ...
    info.pareto_note = 'DTLZ3n2 (m=2): Quarter-circle PF, multimodal. Ref: Deb et al. (2002).';
