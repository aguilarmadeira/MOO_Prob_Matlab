...
%WFG1  WFG1 (n=8, m=3) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 5.06357e+07 ]   (range: 5.06357e+07 )
%   x2   ∈ [0           , 1.41936e+07 ]   (range: 1.41936e+07 )
%   x3   ∈ [0           , 7.8252e+07  ]   (range: 7.8252e+07  )
%   x4   ∈ [0           , 4282.31     ]   (range: 4282.31     )
%   x5   ∈ [0           , 7.2458e+07  ]   (range: 7.2458e+07  )
%   x6   ∈ [0           , 1121.7      ]   (range: 1121.7      )
%   x7   ∈ [0           , 9.40204e+07 ]   (range: 9.40204e+07 )
%   x8   ∈ [0           , 3340.18     ]   (range: 3340.18     )
%
% Effective contrast ratio (max range / min range): 83819.53449944891
...
%
% USAGE:
%   F = WFG1(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = WFG1('bounds')  % Get bounds
%   info = WFG1()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_work = [50635676.66805246;14193559.66533717;78252013.0384272;4282.307629830534;72457982.37414469;1121.700166199415;94020385.77878948;3340.17967124634];
scale_factors = [50635676.66805246;14193559.66533717;78252013.0384272;4282.307629830534;72457982.37414469;1121.700166199415;94020385.77878948;3340.17967124634];
contrast_ratio = 83819.53449944891;
...
if nargin == 0
    ...
    info.pareto_note = 'WFG1: PF shape defined by WFG toolkit shape functions; no simple closed-form. Ref: Huband et al. (2006).';
