...
%
%   x1   ∈ [0           , 3.0199e+07  ]   (range: 3.0199e+07  )
%   x2   ∈ [0           , 6.37192e+07 ]   (range: 6.37192e+07 )
%
% Effective contrast ratio (max range / min range): 2.109979678150038
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [30198965.21328834;63719202.90119831];
scale_factors = [30198965.21328834;63719202.90119831];
contrast_ratio = 2.109979678150038;
