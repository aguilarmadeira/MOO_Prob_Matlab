...
%
%   x1   ∈ [0           , 3126.17     ]   (range: 3126.17     )
%   x2   ∈ [0           , 7101.77     ]   (range: 7101.77     )
%
% Effective contrast ratio (max range / min range): 2.271713642544099
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [3126.172997681446;7101.769847785924];
