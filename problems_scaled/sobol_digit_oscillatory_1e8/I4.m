...
%I4  I4 (n=8, m=3) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 4206.24     ]   (range: 4206.24     )
%   x2   ∈ [0           , 7339.71     ]   (range: 7339.71     )
%   x3   ∈ [0           , 5.85089e+06 ]   (range: 5.85089e+06 )
%   x4   ∈ [0           , 8.70096e+07 ]   (range: 8.70096e+07 )
%   x5   ∈ [0           , 2.53645e+07 ]   (range: 2.53645e+07 )
%   x6   ∈ [0           , 5.64985e+07 ]   (range: 5.64985e+07 )
%   x7   ∈ [0           , 1.47417e+07 ]   (range: 1.47417e+07 )
%   x8   ∈ [0           , 9.60918e+07 ]   (range: 9.60918e+07 )
%
% Effective contrast ratio (max range / min range): 22845.07716911349
...
%
% USAGE:
%   F = I4(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = I4('bounds')  % Get bounds
%   info = I4()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_work = [4206.236472492948;7339.711726507594;5850886.129419614;87009580.09730268;25364473.17872109;56498509.32147203;14741731.41080253;96091796.8056411];
scale_factors = [4206.236472492948;7339.711726507594;5850886.129419614;87009580.09730268;25364473.17872109;56498509.32147203;14741731.41080253;96091796.8056411];
contrast_ratio = 22845.07716911349;
...
if nargin == 0
    ...
    info.pareto_note = 'I4 (m=3): Expected spherical PF (DTLZ2-based) but depends on implementation-specific transformations. Ref: Huband et al. (2005).';
