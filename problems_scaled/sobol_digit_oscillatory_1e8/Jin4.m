...
%JIN4  Jin4 (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 8.73346e+07 ]   (range: 8.73346e+07 )
%   x2   ∈ [0           , 2.13691e+07 ]   (range: 2.13691e+07 )
%
% Effective contrast ratio (max range / min range): 4.086967915256689
...
%
% USAGE:
%   F = Jin4(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = Jin4('bounds')  % Get bounds
%   info = Jin4()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [87334633.59096213;21369052.90226066];
scale_factors = [87334633.59096213;21369052.90226066];
contrast_ratio = 4.086967915256689;
...
if nargin == 0
    ...
    info.pareto_note = 'Jin4: No analytical PF documented. Ref: Jin et al. (2001).';
