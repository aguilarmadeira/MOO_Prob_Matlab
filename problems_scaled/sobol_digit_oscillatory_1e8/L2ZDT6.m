function varargout = L2ZDT6(varargin)
%L2ZDT6  L2ZDT6 (n=10, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 1.20228e+07 ]   (range: 1.20228e+07 )
%   x2   ∈ [0           , 6.53514e+07 ]   (range: 6.53514e+07 )
%   x3   ∈ [0           , 4895.01     ]   (range: 4895.01     )
%   x4   ∈ [0           , 7.68693e+07 ]   (range: 7.68693e+07 )
%   x5   ∈ [0           , 2.18491e+07 ]   (range: 2.18491e+07 )
%   x6   ∈ [0           , 5562.42     ]   (range: 5562.42     )
%   x7   ∈ [0           , 3.29718e+07 ]   (range: 3.29718e+07 )
%   x8   ∈ [0           , 9.29436e+07 ]   (range: 9.29436e+07 )
%   x9   ∈ [0           , 1.778e+06   ]   (range: 1.778e+06   )
%   x10  ∈ [0           , 7385.19     ]   (range: 7385.19     )
%
% Effective contrast ratio (max range / min range): 18987.44320129557
...
%
% USAGE:
%   F = L2ZDT6(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = L2ZDT6('bounds')  % Get bounds
%   info = L2ZDT6()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_work = [12022762.17560232;65351405.7328064;4895.005976162185;76869256.27609347;21849125.77232669;5562.423813979566;32971812.64606928;92943647.94238187;1777997.862660596;7385.191015873912];
scale_factors = [12022762.17560232;65351405.7328064;4895.005976162185;76869256.27609347;21849125.77232669;5562.423813979566;32971812.64606928;92943647.94238187;1777997.862660596;7385.191015873912];
contrast_ratio = 18987.44320129557;
...
if nargin == 0
    ...
    info.pareto_note = 'L2ZDT6: Expected PF same as ZDT6 (f2=1-f1^2); landscape-modified. Ref: Deb et al. (2006).';
...
F = L2ZDT6_orig(x_orig);
varargout{1} = F(:);
return
end  % main wrapper function

% -------------------------------------------------------------------------
% Embedded original problem function (verbatim; only renamed to L2ZDT6_orig)
% -------------------------------------------------------------------------
