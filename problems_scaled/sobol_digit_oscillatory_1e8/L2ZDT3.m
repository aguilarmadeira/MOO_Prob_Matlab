function varargout = L2ZDT3(varargin)
%L2ZDT3  L2ZDT3 (n=30, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 4063.57     ]   (range: 4063.57     )
%   x2   ∈ [0           , 6.33758e+07 ]   (range: 6.33758e+07 )
%   x3   ∈ [0           , 2430.21     ]   (range: 2430.21     )
%   x4   ∈ [0           , 9532.69     ]   (range: 9532.69     )
%   x5   ∈ [0           , 2.75824e+07 ]   (range: 2.75824e+07 )
%   x6   ∈ [0           , 5.49593e+07 ]   (range: 5.49593e+07 )
%   x7   ∈ [0           , 651.121     ]   (range: 651.121     )
%   x8   ∈ [0           , 8.53982e+07 ]   (range: 8.53982e+07 )
%   x9   ∈ [0           , 4.52631e+07 ]   (range: 4.52631e+07 )
%   x10  ∈ [0           , 7.26172e+07 ]   (range: 7.26172e+07 )
%   x11  ∈ [0           , 1.48258e+07 ]   (range: 1.48258e+07 )
%   x12  ∈ [0           , 9368.68     ]   (range: 9368.68     )
%   x13  ∈ [0           , 3396.59     ]   (range: 3396.59     )
%   x14  ∈ [0           , 6.12695e+07 ]   (range: 6.12695e+07 )
%   x15  ∈ [0           , 34.7557     ]   (range: 34.7557     )
%   x16  ∈ [0           , 7925.88     ]   (range: 7925.88     )
%   x17  ∈ [0           , 3.89286e+07 ]   (range: 3.89286e+07 )
%   x18  ∈ [0           , 6625.81     ]   (range: 6625.81     )
%   x19  ∈ [0           , 2094.08     ]   (range: 2094.08     )
%   x20  ∈ [0           , 9987.49     ]   (range: 9987.49     )
%   x21  ∈ [0           , 3.01591e+07 ]   (range: 3.01591e+07 )
%   x22  ∈ [0           , 5.27514e+07 ]   (range: 5.27514e+07 )
%   x23  ∈ [0           , 1.05591e+07 ]   (range: 1.05591e+07 )
%   x24  ∈ [0           , 8.17321e+07 ]   (range: 8.17321e+07 )
%   x25  ∈ [0           , 4.70682e+07 ]   (range: 4.70682e+07 )
%   x26  ∈ [0           , 6.96376e+07 ]   (range: 6.96376e+07 )
%   x27  ∈ [0           , 1.80891e+07 ]   (range: 1.80891e+07 )
%   x28  ∈ [0           , 8.92361e+07 ]   (range: 8.92361e+07 )
%   x29  ∈ [0           , 3.48537e+07 ]   (range: 3.48537e+07 )
%   x30  ∈ [0           , 5744.73     ]   (range: 5744.73     )
%
% Effective contrast ratio (max range / min range): 2567524.958491374
...
%
% USAGE:
%   F = L2ZDT3(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = L2ZDT3('bounds')  % Get bounds
%   info = L2ZDT3()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_work = [4063.567716872397;63375765.3108543;2430.214786308366;9532.689368323758;27582386.67760817;54959344.88346758;651.1211985740266;85398219.1737446;45263109.49266027;72617187.74121873;14825766.8400633;9368.683078974271;3396.592513758626;61269469.45203099;34.75569102101603;7925.879715533448;38928573.25425343;6625.806094525252;2094.077728614081;9987.48974434597;30159143.95135481;52751433.15309205;10559146.90709467;81732096.98525509;47068229.54161845;69637638.83266154;18089097.44596776;89236104.14607322;34853722.20737884;5744.734344046049];
scale_factors = [4063.567716872397;63375765.3108543;2430.214786308366;9532.689368323758;27582386.67760817;54959344.88346758;651.1211985740266;85398219.1737446;45263109.49266027;72617187.74121873;14825766.8400633;9368.683078974271;3396.592513758626;61269469.45203099;34.75569102101603;7925.879715533448;38928573.25425343;6625.806094525252;2094.077728614081;9987.48974434597;30159143.95135481;52751433.15309205;10559146.90709467;81732096.98525509;47068229.54161845;69637638.83266154;18089097.44596776;89236104.14607322;34853722.20737884;5744.734344046049];
contrast_ratio = 2567524.958491374;
...
if nargin == 0
    ...
    info.pareto_note = 'L2ZDT3: Expected PF same as ZDT3 (disconnected); landscape-modified. Ref: Deb et al. (2006).';
...
F = L2ZDT3_orig(x_orig);
varargout{1} = F(:);
return
end  % main wrapper function

% -------------------------------------------------------------------------
% Embedded original problem function (verbatim; only renamed to L2ZDT3_orig)
% -------------------------------------------------------------------------
function f= L2ZDT3_orig(x)
% L2ZDT3 - Linkage L2 variant of ZDT3
%
...
%
% Example T3 (ZDT3), with linkage L2.
%
...
% Converted to MATLAB format by J. F. A. Madeira in 2025.
    ...
    % Linkage matrix M (30x30) - Same as L2ZDT1 and L2ZDT2
    M = [
        0.218418   -0.620254    0.843784    0.914311   -0.788548    0.428212    0.103064   -0.473730   -0.300792   -0.185507    0.330423    0.151614    0.884043   -0.272951   -0.993822    0.511197   -0.0997948  -0.659756    0.575496    0.675617    0.180332   -0.593814   -0.492722    0.0646786  -0.666503   -0.945716   -0.334582    0.611894    0.281032    0.508749;
       ...
       -0.218632   -0.865161   -0.715997    0.220772    0.692356    0.646453   -0.401724    0.615443   -0.0601957  -0.748176   -0.207987   -0.865931    0.613732   -0.525712   -0.995728    0.389633   -0.064173    0.662131   -0.707048   -0.340423    0.606240    0.0951648  -0.160446   -0.394585   -0.167581    0.0679849   0.449799    0.733505   -0.00918638  0.00446808;
       ...
       -0.742377    0.426391    0.408202    0.633885   -0.0351053  -0.723444   -0.577654    0.0276004   0.0712472  -0.622791    0.155451    0.442717   -0.792786    0.925785    0.670266   -0.865566   -0.638281    0.333094    0.477628    0.472610    0.231510    0.821320   -0.589803    0.796275    0.577130    0.101149    0.970191    0.532821    0.814769   -0.0687269;
        ...
        0.0969326   0.089775   -0.241157    0.0835558  -0.420236   -0.686633   -0.711276   -0.00325377  0.435196   -0.710002    0.00283691 -0.168757   -0.134045   -0.655235    0.172361    0.998291    0.376291   -0.962215   -0.363174   -0.887770   -0.519929   -0.560554   -0.984415    0.601529   -0.984103   -0.228237   -0.578066    0.307023    0.606123    0.959635;
        ...
        0.507807    0.804148    0.963269    0.357128   -0.832565   -0.312441    0.327779    0.184745    0.246139   -0.936814   -0.931734   -0.0327827   0.319293    0.044473   -0.641645    0.596118   -0.293934   -0.633730    0.409658    0.759892   -0.257078    0.939616   -0.227661    0.115754    0.109640   -0.240557    0.668420    0.855535   -0.451536    0.264961;
    ...
    % g(x)
    gx = 1 + 9/(n-1) * sum(y(2:n).^2);
    
    % h function (ZDT3 uses discontinuous term)
