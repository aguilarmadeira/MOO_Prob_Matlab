...
%DEB512A  Deb512a (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 5.03735e+07 ]   (range: 5.03735e+07 )
%   x2   ∈ [0           , 1.00582e+07 ]   (range: 1.00582e+07 )
%
% Effective contrast ratio (max range / min range): 5.00818927407223
% WARNING: Bounds missing/incomplete in header; using canonical fallback [0,1]^n.
%
% Pareto information:
%   Pareto front: KNOWN (concave)
%   PF expression: f2 = 1 - f1^2, on g=1 (x2=0)
%   Ideal point: [0 0]
%   Nadir point: [1 1]
%   Pareto set: x2 = 0
%
% USAGE:
%   F = Deb512a(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = Deb512a('bounds')  % Get bounds
%   info = Deb512a()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [50373531.03708045;10058232.28324616];
scale_factors = [50373531.03708045;10058232.28324616];
contrast_ratio = 5.00818927407223;
...
if nargin == 0
    ...
    info.pf_expression = 'f2 = 1 - f1^2, on g=1 (x2=0)';
    ...
    info.pareto_note = 'Deb512a: Concave PF. Ref: Deb (1999).';
