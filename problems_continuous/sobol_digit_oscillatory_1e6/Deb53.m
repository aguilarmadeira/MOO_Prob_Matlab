...
%
%   x1   ∈ [0           , 189980      ]   (range: 189980      )
%   x2   ∈ [0           , 622.648     ]   (range: 622.648     )
%
% Effective contrast ratio (max range / min range): 305.1159052449444
%
% Pareto information:
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [189979.8841294762;622.6482489562844];
scale_factors = [189979.8841294762;622.6482489562844];
contrast_ratio = 305.1159052449444;
