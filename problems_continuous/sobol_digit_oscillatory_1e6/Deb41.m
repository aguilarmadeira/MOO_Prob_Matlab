...
%
%   x1   ∈ [71.0465     , 710.465     ]   (range: 639.419     )
%   x2   ∈ [0           , 487.814     ]   (range: 487.814     )
%
% Effective contrast ratio (max range / min range): 1.456426712535566
%
% Pareto information:
...
lb_orig = [0.1;0];
ub_orig = [1;1];
lb_work = [71.04651997965533;0];
ub_work = [710.4651997965532;487.8139034951295];
scale_factors = [710.4651997965532;487.8139034951295];
contrast_ratio = 1.456426712535566;
