function varargout = SK1(varargin)
%SK1  SK1 (n=1, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [-8.51474e+06, 8.51474e+06 ]   (range: 1.70295e+07 )
%
...
%
% USAGE:
%   F = SK1(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = SK1('bounds')  % Get bounds
%   info = SK1()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
lb_orig = -10;
ub_orig = 10;
lb_work = -8514735.318702016;
ub_work = 8514735.318702016;
scale_factors = 851473.5318702017;
contrast_ratio = 1;
...
if nargin == 0
    ...
    info.pareto_note = 'SK1: 1D problem. PF depends on function definition. Ref: Huband et al. (2006).';
...
% -------------------------------------------------------------------------
% Embedded original problem function (verbatim; only renamed to SK1_orig)
% -------------------------------------------------------------------------
function f = SK1_orig(x)
% SK1 function
%
