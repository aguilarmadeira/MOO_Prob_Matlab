...
%
%   x1   ∈ [-515878     , 515878      ]   (range: 1.03176e+06 )
%   x2   ∈ [-3578.19    , 3578.19     ]   (range: 7156.38     )
%   x3   ∈ [-1.91843e+06, 1.91843e+06 ]   (range: 3.83685e+06 )
%
% Effective contrast ratio (max range / min range): 536.1438511901836
%
% Pareto information:
...
lb_orig = [-5;-5;-5];
ub_orig = [5;5;5];
lb_work = [-515877.9125927173;-3578.190880623358;-1918425.039031002];
ub_work = [515877.9125927173;3578.190880623358;1918425.039031002];
scale_factors = [103175.5825185435;715.6381761246716;383685.0078062004];
contrast_ratio = 536.1438511901836;
