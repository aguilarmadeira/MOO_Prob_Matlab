...
%MHHM1  MHHM1 (n=1, m=3) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 7.86293     ]   (range: 7.86293     )
%
...
%
% USAGE:
%   F = MHHM1(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = MHHM1('bounds')  % Get bounds
%   info = MHHM1()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_orig = 1;
lb_work = 0;
ub_work = 7.862926871564609;
scale_factors = 7.862926871564609;
contrast_ratio = 1;
...
if nargin == 0
    ...
    info.pareto_note = 'MHHM1: 1D tri-objective. PF depends on function definition. Ref: Huband et al. (2006).';
