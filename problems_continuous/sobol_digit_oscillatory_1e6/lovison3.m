...
%LOVISON3  lovison3 (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 612968      ]   (range: 612968      )
%   x2   ∈ [-2434.59    , 2434.59     ]   (range: 4869.19     )
%
% Effective contrast ratio (max range / min range): 167.8495663408664
%
% Pareto information:
...
%
% USAGE:
%   F = lovison3(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = lovison3('bounds')  % Get bounds
%   info = lovison3()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
lb_orig = [0;-4];
ub_orig = [6;4];
lb_work = [0;-2434.594208555749];
ub_work = [612968.3731831007;2434.594208555749];
scale_factors = [102161.3955305168;608.6485521389371];
contrast_ratio = 167.8495663408664;
...
if nargin == 0
    ...
    info.pareto_note = 'lovison3: No analytical PF documented. Ref: Lovison (2010).';
