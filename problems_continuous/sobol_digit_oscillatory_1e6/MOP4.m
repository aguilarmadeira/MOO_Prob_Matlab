...
%
%   x1   ∈ [-2.45289e+06, 2.45289e+06 ]   (range: 4.90579e+06 )
%   x2   ∈ [-4.93338e+06, 4.93338e+06 ]   (range: 9.86676e+06 )
%   x3   ∈ [-1.05537e+06, 1.05537e+06 ]   (range: 2.11073e+06 )
%
% Effective contrast ratio (max range / min range): 4.674571340104756
%
% Pareto information:
...
lb_orig = [-5;-5;-5];
ub_orig = [5;5;5];
lb_work = [-2452893.347244196;-4933381.485630235;-1055365.535510188];
ub_work = [2452893.347244196;4933381.485630235;1055365.535510188];
scale_factors = [490578.6694488391;986676.297126047;211073.1071020377];
contrast_ratio = 4.674571340104756;
