...
%
%   x1   ∈ [-163677     , 163677      ]   (range: 327354      )
%   x2   ∈ [-2.96607e+08, 2.96607e+08 ]   (range: 5.93214e+08 )
%
% Effective contrast ratio (max range / min range): 1812.147183536462
%
% Pareto information:
...
lb_orig = [-400;-400];
ub_orig = [400;400];
lb_work = [-163677.0896070024;-296606976.9407746];
ub_work = [163677.0896070024;296606976.9407746];
scale_factors = [409.1927240175061;741517.4423519365];
contrast_ratio = 1812.147183536462;
