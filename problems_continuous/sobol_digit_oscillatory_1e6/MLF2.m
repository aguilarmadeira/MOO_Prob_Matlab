...
%
%   x1   ∈ [-258407     , 258407      ]   (range: 516813      )
%   x2   ∈ [-1219.99    , 1219.99     ]   (range: 2439.98     )
%
% Effective contrast ratio (max range / min range): 211.810021480996
%
% Pareto information:
...
lb_orig = [-2;-2];
ub_orig = [2;2];
lb_work = [-258406.5116477264;-1219.991905203178];
ub_work = [258406.5116477264;1219.991905203178];
scale_factors = [129203.2558238632;609.9959526015891];
contrast_ratio = 211.810021480996;
