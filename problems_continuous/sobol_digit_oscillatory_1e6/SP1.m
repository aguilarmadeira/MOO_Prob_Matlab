...
%SP1  SP1 (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [-819260     , 4.0963e+06  ]   (range: 4.91556e+06 )
%   x2   ∈ [-421.087    , 2105.44     ]   (range: 2526.52     )
%
% Effective contrast ratio (max range / min range): 1945.58152818091
%
% Pareto information:
...
%
% USAGE:
%   F = SP1(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = SP1('bounds')  % Get bounds
%   info = SP1()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
lb_orig = [-1;-1];
ub_orig = [5;5];
lb_work = [-819259.6858632909;-421.0873068009062];
ub_work = [4096298.429316455;2105.436534004531];
scale_factors = [819259.6858632909;421.0873068009063];
contrast_ratio = 1945.58152818091;
...
if nargin == 0
    ...
    info.pareto_note = 'SP1: No closed-form PF documented. Ref: Huband et al. (2006).';
