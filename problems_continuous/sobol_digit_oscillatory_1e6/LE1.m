...
%
%   x1   ∈ [-3.94214e+06, 7.88428e+06 ]   (range: 1.18264e+07 )
%   x2   ∈ [-1.5322e+06 , 3.0644e+06  ]   (range: 4.5966e+06  )
%
% Effective contrast ratio (max range / min range): 2.572860332275264
%
% Pareto information:
...
lb_orig = [-5;-5];
ub_orig = [10;10];
lb_work = [-3942139.77327685;-1532201.23293311];
ub_work = [7884279.546553699;3064402.465866219];
scale_factors = [788427.95465537;306440.2465866219];
contrast_ratio = 2.572860332275264;
