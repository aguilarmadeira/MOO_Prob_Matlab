...
%
%   x1   ∈ [0           , 255068      ]   (range: 255068      )
%   x2   ∈ [0           , 793.15      ]   (range: 793.15      )
%
% Effective contrast ratio (max range / min range): 321.5886666313793
%
% Pareto information:
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [255067.9407062595;793.1496572254238];
scale_factors = [255067.9407062595;793.1496572254238];
contrast_ratio = 321.5886666313793;
