...
%
%   x1   ∈ [-355.52     , 1422.08     ]   (range: 1777.6      )
%   x2   ∈ [-961430     , 3.84572e+06 ]   (range: 4.80715e+06 )
%   x3   ∈ [-16688.1    , 66752.3     ]   (range: 83440.4     )
%
% Effective contrast ratio (max range / min range): 2704.294353434715
%
% Pareto information:
...
lb_orig = [-1;-1;-1];
ub_orig = [4;4;4];
lb_work = [-355.5196071673236;-961429.6661979207;-16688.07379566025];
ub_work = [1422.078428669294;3845718.664791683;66752.29518264103];
scale_factors = [355.5196071673234;961429.6661979208;16688.07379566026];
contrast_ratio = 2704.294353434715;
