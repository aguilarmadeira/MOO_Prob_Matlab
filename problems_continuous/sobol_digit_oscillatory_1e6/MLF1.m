...
%MLF1  MLF1 (n=1, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [0           , 602.29      ]   (range: 602.29      )
%
...
%
% USAGE:
%   F = MLF1(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = MLF1('bounds')  % Get bounds
%   info = MLF1()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
ub_orig = 20;
lb_work = 0;
ub_work = 602.2904308335477;
scale_factors = 30.11452154167739;
contrast_ratio = 1;
...
if nargin == 0
    ...
    info.pareto_note = 'MLF1: 1D, PF shape depends on function definition. Ref: Huband et al. (2006).';
