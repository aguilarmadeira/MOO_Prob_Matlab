...
%
%   x1   ∈ [0           , 470554      ]   (range: 470554      )
%   x2   ∈ [0           , 744797      ]   (range: 744797      )
%
% Effective contrast ratio (max range / min range): 1.582807513414763
%
% Pareto information:
...
ub_orig = [1;1];
lb_work = [0;0];
ub_work = [470554.4671851302;744797.1461315048];
scale_factors = [470554.4671851302;744797.1461315048];
contrast_ratio = 1.582807513414763;
