...
%
%   x1   ∈ [-357.18     , 0           ]   (range: 357.18      )
%   x2   ∈ [-146437     , 146437      ]   (range: 292875      )
%
% Effective contrast ratio (max range / min range): 409.9815193870561
%
% Pareto information:
...
lb_orig = [-0.5;-0.5];
ub_orig = [0;0.5];
lb_work = [-357.1802231545697;-146437.2905839182];
ub_work = [0;146437.2905839182];
scale_factors = [714.3604463091394;292874.5811678365];
contrast_ratio = 409.9815193870561;
