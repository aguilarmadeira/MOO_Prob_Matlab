...
%
%   x1   ∈ [0           , 529.088     ]   (range: 529.088     )
%   x2   ∈ [0           , 1600.22     ]   (range: 1600.22     )
%
% Effective contrast ratio (max range / min range): 3.024484394006954
%
% Pareto information:
...
ub_orig = [3;3];
lb_work = [0;0];
ub_work = [529.0876934593103;1600.21747192882];
scale_factors = [176.3625644864368;533.4058239762732];
contrast_ratio = 3.024484394006954;
