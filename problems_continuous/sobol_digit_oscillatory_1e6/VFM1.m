...
%
%   x1   ∈ [-1.08122e+06, 1.08122e+06 ]   (range: 2.16244e+06 )
%   x2   ∈ [-1.00016e+06, 1.00016e+06 ]   (range: 2.00032e+06 )
%
% Effective contrast ratio (max range / min range): 1.08104896977767
%
% Pareto information:
...
lb_orig = [-2;-2];
ub_orig = [2;2];
lb_work = [-1081219.607000505;-1000157.84411956];
ub_work = [1081219.607000505;1000157.84411956];
scale_factors = [540609.8035002525;500078.9220597798];
contrast_ratio = 1.08104896977767;
