...
%CAM2  CAM2 (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [32516.9     , 325169      ]   (range: 292652      )
%   x2   ∈ [0           , 890361      ]   (range: 890361      )
%
% Effective contrast ratio (max range / min range): 2.738147941733374
%
% Pareto information:
...
%
% USAGE:
%   F = CAM2(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = CAM2('bounds')  % Get bounds
%   info = CAM2()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
lb_orig = [0.1;0];
ub_orig = [1;1];
lb_work = [32516.90371568222;0];
ub_work = [325169.037156822;890360.9298063752];
scale_factors = [325169.037156822;890360.9298063752];
contrast_ratio = 2.738147941733374;
...
if nargin == 0
    ...
    info.pareto_note = 'CAM2: No analytical PF documented. Ref: Deb (1999).';
