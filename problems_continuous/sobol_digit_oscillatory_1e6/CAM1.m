...
%CAM1  CAM1 (n=2, m=2) test problem (heterogeneous WORK-space wrapper).
%
% INPUT SPACE (SOBOL_DIGIT_OSCILLATORY HETEROGENEITY):
%
%   x1   ∈ [30261.8     , 302618      ]   (range: 272356      )
%   x2   ∈ [0           , 637519      ]   (range: 637519      )
%
% Effective contrast ratio (max range / min range): 2.106678216014586
%
% Pareto information:
...
%
% USAGE:
%   F = CAM1(x)            % Evaluate objectives at point x (nD vector)
%   [lb, ub] = CAM1('bounds')  % Get bounds
%   info = CAM1()          % Get complete problem information
%
% Reference:
%   J. F. A. Madeira,
...
lb_orig = [0.1;0];
ub_orig = [1;1];
lb_work = [30261.79242731779;0];
ub_work = [302617.9242731779;637518.5888418553];
scale_factors = [302617.9242731778;637518.5888418553];
contrast_ratio = 2.106678216014586;
...
if nargin == 0
    ...
    info.pareto_note = 'CAM1: No analytical PF documented. Ref: Deb (1999).';
