...
%
%   x1   ∈ [-1247.25    , 1247.25     ]   (range: 2494.5      )
%   x2   ∈ [-2136.4     , 2136.4      ]   (range: 4272.8      )
%
% Effective contrast ratio (max range / min range): 1.712888143230811
%
% Pareto information:
...
lb_orig = [-4;-4];
ub_orig = [4;4];
lb_work = [-1247.249431492818;-2136.398762855418];
ub_work = [1247.249431492818;2136.398762855418];
scale_factors = [311.8123578732046;534.0996907138544];
contrast_ratio = 1.712888143230811;
