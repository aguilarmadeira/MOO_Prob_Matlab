...
%
%   x1   ∈ [-847.737    , 847.737     ]   (range: 1695.47     )
%   x2   ∈ [-80887.4    , 80887.4     ]   (range: 161775      )
%
% Effective contrast ratio (max range / min range): 95.41565364442731
%
% Pareto information:
...
lb_orig = [-1;-1];
ub_orig = [1;1];
lb_work = [-847.737239148867;-80887.40279211134];
ub_work = [847.737239148867;80887.40279211134];
scale_factors = [847.737239148867;80887.40279211134];
contrast_ratio = 95.41565364442731;
