...
%   x5   ∈ [-0.03       , 0.03        ]   (range: 0.06        )
%   x6   ∈ [-0.003      , 0.003       ]   (range: 0.006       )
%   x7   ∈ [-0.0005     , 0.0005      ]   (range: 0.001       )
...
lb_work = [-0.3;-3;-30;-300;-0.03;-0.003;-0.0005;-0.3;-3;-30];
ub_work = [0.3;3;30;300;0.03;0.003;0.0005;0.3;3;30];
