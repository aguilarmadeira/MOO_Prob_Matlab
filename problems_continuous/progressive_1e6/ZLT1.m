...
%   x2   ∈ [-10000      , 10000       ]   (range: 20000       )
%   x3   ∈ [-100000     , 100000      ]   (range: 200000      )
%   x4   ∈ [-1e+06      , 1e+06       ]   (range: 2e+06       )
%   x5   ∈ [-100        , 100         ]   (range: 200         )
%   x6   ∈ [-10         , 10          ]   (range: 20          )
%   x7   ∈ [-1          , 1           ]   (range: 2           )
%   x8   ∈ [-1000       , 1000        ]   (range: 2000        )
%   x9   ∈ [-10000      , 10000       ]   (range: 20000       )
%   x10  ∈ [-100000     , 100000      ]   (range: 200000      )
%
...
lb_work = [-1000;-10000;-100000;-1000000;-100;-10;-1;-1000;-10000;-100000];
ub_work = [1000;10000;100000;1000000;100;10;1;1000;10000;100000];
