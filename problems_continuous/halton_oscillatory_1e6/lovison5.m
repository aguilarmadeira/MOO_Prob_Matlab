...
%
%   x1   ∈ [-500500     , 2.002e+06   ]   (range: 2.5025e+06  )
%   x2   ∈ [-250.75     , 1003        ]   (range: 1253.75     )
%   x3   ∈ [-750250     , 3.001e+06   ]   (range: 3.75125e+06 )
%
...
lb_orig = [-1;-1;-1];
ub_orig = [4;4;4];
lb_work = [-500500;-250.75;-750250];
ub_work = [2002000;1003;3001000];
