...
%
%   x1   ∈ [-1          , 4           ]   (range: 5           )
%   x2   ∈ [-4.64159    , 18.5664     ]   (range: 23.2079     )
%   x3   ∈ [-21.5443    , 86.1774     ]   (range: 107.722     )
%
...
lb_orig = [-1;-1;-1];
ub_orig = [4;4;4];
lb_work = [-1;-4.641588833612779;-21.54434690031883];
ub_work = [4;18.56635533445111;86.17738760127534];
