...
%   x2   ∈ [-1.39248    , 1.39248     ]   (range: 2.78495     )
%   x3   ∈ [-6.4633     , 6.4633      ]   (range: 12.9266     )
%   x4   ∈ [-30         , 30          ]   (range: 60          )
%   x5   ∈ [-0.064633   , 0.064633    ]   (range: 0.129266    )
%   x6   ∈ [-0.0139248  , 0.0139248   ]   (range: 0.0278495   )
%   x7   ∈ [-0.003      , 0.003       ]   (range: 0.006       )
%   x8   ∈ [-0.3        , 0.3         ]   (range: 0.6         )
%   x9   ∈ [-1.39248    , 1.39248     ]   (range: 2.78495     )
%   x10  ∈ [-6.4633     , 6.4633      ]   (range: 12.9266     )
%
...
lb_work = [-0.3;-1.392476650083833;-6.46330407009565;-30;-0.06463304070095652;-0.01392476650083834;-0.003;-0.3;-1.392476650083833;-6.46330407009565];
ub_work = [0.3;1.392476650083833;6.46330407009565;30;0.06463304070095652;0.01392476650083834;0.003;0.3;1.392476650083833;6.46330407009565];
