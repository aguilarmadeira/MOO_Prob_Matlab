...
%
%   x1   ∈ [-10         , 10          ]   (range: 20          )
%   x2   ∈ [-46.4159    , 46.4159     ]   (range: 92.8318     )
%   x3   ∈ [-215.443    , 215.443     ]   (range: 430.887     )
...
lb_orig = [-10;-10;-10;-10];
ub_orig = [10;10;10;10];
lb_work = [-10;-46.41588833612779;-215.4434690031883;-1000];
ub_work = [10;46.41588833612779;215.4434690031883;1000];
scale_factors = [1;4.641588833612778;21.54434690031884;100];
contrast_ratio = 100;
