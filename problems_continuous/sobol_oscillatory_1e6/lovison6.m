...
%
%   x1   ∈ [-149289     , 597156      ]   (range: 746445      )
%   x2   ∈ [-648.789    , 2595.16     ]   (range: 3243.95     )
%   x3   ∈ [-399039     , 1.59616e+06 ]   (range: 1.9952e+06  )
%
...
lb_orig = [-1;-1;-1];
ub_orig = [4;4;4];
lb_work = [-149289.0625;-648.7890625;-399039.0625];
ub_work = [597156.25;2595.15625;1596156.25];
