...
%   x6   ∈ [-1000       , 1000        ]   (range: 2000        )
%   x7   ∈ [-1000       , 1000        ]   (range: 2000        )
%   x8   ∈ [-1000       , 1000        ]   (range: 2000        )
%   x9   ∈ [-1000       , 1000        ]   (range: 2000        )
%   x10  ∈ [-1000       , 1000        ]   (range: 2000        )
%
...
lb_work = [-1000;-1000;-1000;-1000;-1000;-1000;-1000;-1000;-1000;-1000];
ub_work = [1000;1000;1000;1000;1000;1000;1000;1000;1000;1000];
