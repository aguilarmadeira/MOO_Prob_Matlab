...
%   x6   ∈ [-5.12       , 5.12        ]   (range: 10.24       )
%   x7   ∈ [-5.12       , 5.12        ]   (range: 10.24       )
%   x8   ∈ [-5.12       , 5.12        ]   (range: 10.24       )
%   x9   ∈ [-5.12       , 5.12        ]   (range: 10.24       )
%   x10  ∈ [-5.12       , 5.12        ]   (range: 10.24       )
%
...
lb_work = [-5.12;-5.12;-5.12;-5.12;-5.12;-5.12;-5.12;-5.12;-5.12;-5.12];
ub_work = [5.12;5.12;5.12;5.12;5.12;5.12;5.12;5.12;5.12;5.12];
