...
%   x4   ∈ [-5          , 5           ]   (range: 10          )
%   x5   ∈ [-5          , 5           ]   (range: 10          )
%   x6   ∈ [-1500       , 1500        ]   (range: 3000        )
%   x7   ∈ [-1500       , 1500        ]   (range: 3000        )
%   x8   ∈ [-1500       , 1500        ]   (range: 3000        )
%   x9   ∈ [-1500       , 1500        ]   (range: 3000        )
%   x10  ∈ [-1500       , 1500        ]   (range: 3000        )
%
...
lb_work = [0;-5;-5;-5;-5;-1500;-1500;-1500;-1500;-1500];
ub_work = [1;5;5;5;5;1500;1500;1500;1500;1500];
